...
namespace Pinetime {
  namespace Applications {
    namespace Screens {
      ...
      public:
        explicit Timeline(DisplayApp* app, Controllers::DateTime& dateTimeController, Pinetime::Controllers::CalendarManager& calendarManager, Pinetime::Components::LittleVgl& lvgl);
        ~Timeline() override;
      ...
      private:
        ...
        //lv_color1_t cbuf[LV_IMG_BUF_SIZE_INDEXED_1BIT(TIMETABLE_WIDTH, TIMETABLE_HEIGHT)]{};
      };
    }
  }
}
