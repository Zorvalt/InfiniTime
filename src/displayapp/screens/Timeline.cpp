...
Timeline::Timeline(DisplayApp* app, Pinetime::Controllers::CalendarManager& calendarManager)
...
bool Timeline::OnTouchEvent(Pinetime::Applications::TouchEvents event) {
  switch (event) {
